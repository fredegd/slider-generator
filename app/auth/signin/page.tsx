    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl">Welcome to Slide Generator</CardTitle>
          <CardDescription>Sign in or create an account to save your presentations</CardDescription>
        </CardHeader>
        <CardContent>
